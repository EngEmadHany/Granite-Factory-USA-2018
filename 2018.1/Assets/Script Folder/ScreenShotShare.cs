...
public class ScreenShotShare : MonoBehaviour
{
    ...
    public string ScreenshotName = "ARScreenShot.png";
 ...
 StartCoroutine( CallSocialShareRoutine() );
    ...
    {
        isProcessing = true;
        Debug.Log("No sharing set up for this vvvvvv.");
        ...
        if (!Application.isEditor)
        {
            ...
            Debug.Log("No sharing set up for this platformyyyy.");
            ...
            Debug.Log("No sharing set up for this platformaaaaa.");
        }
        isProcessing = false;
    }
#endif
